...
# @router.get("/init")
# async def save_init(place_repo: PlaceRepository = Depends()) -> :
#     place_list = []
...
# async def get_one_travel_route(id: int, user_id: str = Depends(authenticate), travel_route_repo: TravelRouteRepository = Depends()) -> GetTravelRouteOneResponse:
#     travel_route = travel_route_repo.get_by_id(id)
#
#     return await generate_dto(travel_route=travel_route, user_id=user_id)
#
#
# @router.delete("/{id}", status_code=204)
# async def delete_one_travel_route(id: int) -> None:
#     pass
