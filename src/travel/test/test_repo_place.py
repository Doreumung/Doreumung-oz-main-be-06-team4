...
class TestPlaceRepository:
    @pytest.fixture
    def place_repository(self, async_session: AsyncSession):
        return PlaceRepository(async_session)

    async def test_save_place_model(self, async_session: AsyncSession, place_repository: PlaceRepository):
    ...
    async def test_update_place_model(self, async_session: AsyncSession, place_repository: PlaceRepository):
        place = Place(name="한라산", theme="해변", address="제주시", latitude=123.21314214, longitude=123.21314214)
        new_place = await place_repository.save(place)
        place_update = PlaceUpdate(name="한라산")
        assert await place_repository.update(place_update, 1)

    async def test_delete_place_model(self, async_session: AsyncSession, place_repository: PlaceRepository):
        place = Place(name="한라산", theme="해변", address="제주시", latitude=123.21314214, longitude=123.21314214)
        new_place = await place_repository.save(place)
    ...
    async def test_get_by_theme_and_region(self, async_session: AsyncSession, place_repository: PlaceRepository):
        place = Place(name="한라산", theme="해변", address="제주시", latitude=123.21314214, longitude=123.21314214)
        new_place = await place_repository.save(place)
    ...
    async def test_get_place_list(self, async_session: AsyncSession, place_repository: PlaceRepository):
        place_list=[]
        place_list.append(Place(name="한라산1", theme="자연", address="서귀포시", latitude=123.21314214, longitude=123.21314214))
        place_list.append(Place(name="한라산2", theme="해변", address="한경면", latitude=123.21314214, longitude=123.21314214))
        place_list.append(Place(name="한라산3", theme="액티비티", address="한림읍", latitude=123.21314214, longitude=123.21314214))
        place_list.append(Place(name="한라산4", theme="카페", address="애월읍", latitude=123.21314214, longitude=123.21314214))
        place_list.append(Place(name="한라산5", theme="전시", address="조천읍", latitude=123.21314214, longitude=123.21314214))
    ...
    async def test_get_by_id(self, async_session: AsyncSession, place_repository: PlaceRepository):
        place = Place(name="한라산", theme="해변", address="제주시", latitude=123.21314214, longitude=123.21314214)
        new_place = await place_repository.save(place)
